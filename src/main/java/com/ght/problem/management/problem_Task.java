...
public class problem_Task implements java.io.Serializable {
	...
	public problem_Task(java.lang.String assignTo, java.lang.String caller,
			java.util.Date duDate, java.lang.String priority,
			java.lang.String shortDescription, java.lang.String taskNumber) {
		this.assignTo = assignTo;
		this.caller = caller;
		this.duDate = duDate;
		this.priority = priority;
